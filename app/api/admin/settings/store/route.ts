...
export async function POST(req: NextRequest) {
  try {
    ...
    await setSettings({
      ...
      about_heading: parsed.about_heading !== undefined ? String(parsed.about_heading) : undefined,
      about_content: parsed.about_content !== undefined ? String(parsed.about_content) : undefined,
    });
